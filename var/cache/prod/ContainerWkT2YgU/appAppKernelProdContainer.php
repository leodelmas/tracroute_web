...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tPdA88wAGq', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => ' 8889', 'dbname' => 'tracroute_web', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bHVjE+Qq4C', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('aSNQOwxwRK6HeoxBFXePSWN7zfUX7ONAj6rvY9vzDy5BaVKJCxRSDLOjRBPDCRbf'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                68 => 'ps_metrics',
                69 => 'graphnvd3',
                70 => 'ps_googleanalytics',
                71 => 'statsbestvouchers',
            ...
            'modules_translation_paths' => [
                ...
                32 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                ...
                37 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                ...
                44 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                ...
                50 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                ...
                54 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/mbeshipping/translations'),
                ...
                60 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/ps_metrics/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
            ...
            'kernel.secret' => 'aSNQOwxwRK6HeoxBFXePSWN7zfUX7ONAj6rvY9vzDy5BaVKJCxRSDLOjRBPDCRbf',
