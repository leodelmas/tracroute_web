...
return [
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/modules/(?'
                    .'|m(?'
                        .'|bo/modules/catalog/see_more/(\\d+)(*:8698)'
                        .'|etrics/api(?:/([^/]++))?(*:8731)'
                    .')'
                    .'|link\\-widget/(?'
                        .'|edit/([^/]++)(?'
    ...
    [ // $dynamicRoutes
        ...
        8698 => [[['_route' => 'admin_mbo_module_see_more', '_controller' => 'mbo.controller.modules.catalog:seeMoreAction'], ['moduleId'], ['GET' => 0], null, false, true, null]],
        8731 => [[['_route' => 'metrics_api_resolver', 'query' => '', '_controller' => 'PrestaShop\\Module\\Ps_metrics\\Controller\\Admin\\MetricsResolverController::resolve'], ['query'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        8773 => [
        ...
        8795 => [[['_route' => 'admin_link_block_delete', '_controller' => 'PrestaShop\\Module\\LinkList\\Controller\\Admin\\Improve\\Design\\LinkBlockController::deleteAction', '_legacy_controller' => 'AdminLinkWidget'], ['linkBlockId'], ['POST' => 0], null, false, true, null]],
        8827 => [
