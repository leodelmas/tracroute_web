...
class Mbeshipping extends CarrierModule
{
    ...
    public function installTab()
    {
        ...
        $tab5 = new Tab();
        $tab5->active = 1;
        $tab5->class_name = 'AdminMbeConfiguration';
        foreach (Language::getLanguages(true) as $lang) {
            $tab5->name[$lang['id_lang']] = $this->l('Configuration');
        }
        $tab5->id_parent = (int)Tab::getIdFromClassName('AdminParentShipping');
        $tab5->module = $this->name;

        return $tab5->add() && $tab->add() && $tab2->add() && $tab3->add() && $tab4->add();
    }
    ...
    public function uninstallTab()
    {
        ...
        $id_tab5 = (int)Tab::getIdFromClassName('AdminMbeConfiguration');
        if ($id_tab5) {
            $tab5 = new Tab($id_tab5);
            $result &= $tab5->delete();
        }
